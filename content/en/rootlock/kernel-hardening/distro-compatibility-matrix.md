...
type: docs
aliases:
  - /docs/kernel-hardening/distro-compatibility-matrix/
toc: true
---
...
Root Lock runs as a **guest** on AWS EC2 (including Nitro), KVM, VMware, and other cloud hypervisors. Use a distribution from this matrix and the same installer as on local hardware. For nested guests, see [Bare metal, virtual machines, and nested VMs](../../introduction/system-requirements/#bare-metal-virtual-machines-and-nested-vms).
