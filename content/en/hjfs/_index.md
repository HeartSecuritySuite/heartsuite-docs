...
HJFS does not control which programs run or which network connections they open. Those are [HeartSuite Root Lock](../../docs/)'s domain. HJFS and Core Secure address different problems and can be deployed together.
...
- [Deployment Scenarios](deployment-scenarios/) — Where HJFS fits, where it fits alongside HeartSuite Root Lock, and where it does not apply.
- [How HJFS Compares](how-it-compares/) — What HJFS is not, what it complements, and how to decide between HJFS alone or with HeartSuite Root Lock.
