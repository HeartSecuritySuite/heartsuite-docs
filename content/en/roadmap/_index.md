...
> Documents every hook change from 5.19.6 to 6.18: EXEC-001 moved from `bprm_execve()` to `alloc_bprm()`, syscall slots renumbered from 451–454 to 470–473, and `const struct path` type qualifier incompatibility resolved. 
