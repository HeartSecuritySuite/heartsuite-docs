...
Compare this to the tools in the first table: in most of them, root is sufficient to disable enforcement by killing or unloading a control plane. Root Lock is deliberately not in that category.
